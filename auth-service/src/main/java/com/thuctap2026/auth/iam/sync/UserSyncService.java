...
public class UserSyncService {
    ...
    public UserSyncService(
        ...
        this.hrSyncClient = RestClient.builder().baseUrl(hrSyncBaseUrl).build();
    ...
    private void processOne(UserSyncOutbox outbox) {
        ...
        try {
            hrSyncClient.post()
                .uri("/employees/internal/users/sync")
    ...
    private long calculateBackoffSeconds(int retryCount) {
        ...
        return Math.min(300L, (long) retryBaseDelaySeconds * multiplier);
    }
